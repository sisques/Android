...
import es.unizar.eina.ebrozon.lib.adaptadorOfertasComprasEnviadas;

public class ofertasYComprasEnviadas extends AppCompatActivity {
    ...
    private final String ofertas =  "/listarOfertasRealizadas";  //?un=  nombre usuario


    private final String compras =  "/listarOfertasRealizadasAceptadasPendientes";   //?un=  nombre usuario
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView m = (TextView) findViewById( R.id.mensajesTitulo );
        m.setText( R.string.ofertas_y_pujas_enviadas );
    ...
    private void continuar(){
        lista.setAdapter(new adaptadorOfertasComprasEnviadas(this, datos, ne, un));
    }
    ...
    private void anyadirOfertas(JSONArray JSONelementos) {
        ...
        for (int i=0; i<JSONelementos.length(); i++) {
            try {
                ...
                datos[i][3] = JSONelemento.get("vendedor").toString();
                ...
                datos[i][4] = fecha;
                datos[i][5] = getResources().getString(R.string.boton_iniciar_chat);
                datos[i][6] = getResources().getString(R.string.boton_cancelar_oferta);
    ...
    private void anyadirCompras(JSONArray JSONelementos) {
        ...
        for (int i=0; i<JSONelementos.length(); i++) {
            try {
                ...
                datos[neInit +i][3] = JSONelemento.get("vendedor").toString();
                ...
                datos[neInit +i][5] = getResources().getString(R.string.boton_iniciar_chat);
                datos[neInit +i][6] = getResources().getString(R.string.boton_cancelar_compra);
                datos[neInit +i][7] = JSONelemento.get("identificador").toString();
                datos[i][8] = "compra";
